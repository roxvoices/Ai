...
/* =========================
   VOICE ARCHITECT PROFILE
========================= */

// Placeholder export to satisfy VoiceArchitect.tsx
// You can customize this with real voice profiles later
export const architectVoiceProfile = () => {
  return {
    name: "Default Architect Voice",
    pitch: 1,
    rate: 1,
    style: "neutral",
  };
